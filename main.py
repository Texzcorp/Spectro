...
def download_images(themes, num_wallpapers, progress_queue):
    for theme in themes:
        ...
        downloader.download(query, limit=large_limit, output_dir="temp", adult_filter_off=False, force_replace=False, timeout=60)
    ...
    move_full_hd_images("temp", num_wallpapers, progress_queue)  # Appeler la fonction de filtrage des images
